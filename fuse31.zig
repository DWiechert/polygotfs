...
pub extern fn fuse_log_enable_syslog(ident: [*c]const u8, option: c_int, facility: c_int) void;
pub extern fn fuse_log_close_syslog() void;
...
// /usr/include/fuse3/fuse_common.h:60:11: warning: struct demoted to opaque type - has bitfield
...
// /usr/include/fuse3/fuse_common.h:682:11: warning: struct demoted to opaque type - has bitfield
pub const struct_fuse_conn_info = opaque {};
...
pub extern fn fuse_apply_conn_info_opts(opts: ?*struct_fuse_conn_info_opts, conn: ?*struct_fuse_conn_info) void;
...
pub const struct_libfuse_version = extern struct {
    major: u32 = @import("std").mem.zeroes(u32),
    minor: u32 = @import("std").mem.zeroes(u32),
    hotfix: u32 = @import("std").mem.zeroes(u32),
...
pub extern fn fuse_set_fail_signal_handlers(se: ?*struct_fuse_session) c_int;
pub extern fn fuse_remove_signal_handlers(se: ?*struct_fuse_session) void;
pub extern fn fuse_set_feature_flag(conn: ?*struct_fuse_conn_info, flag: u64) bool;
pub extern fn fuse_unset_feature_flag(conn: ?*struct_fuse_conn_info, flag: u64) void;
pub extern fn fuse_get_feature_flag(conn: ?*struct_fuse_conn_info, flag: u64) bool;
pub extern fn fuse_convert_to_conn_want_ext(conn: ?*struct_fuse_conn_info) c_int;
// /usr/include/fuse3/fuse_common.h:1155:1: warning: ignoring StaticAssert declaration
...
pub const struct_statvfs = extern struct {
    ...
    f_type: c_uint = @import("std").mem.zeroes(c_uint),
...
pub const FUSE_READDIR_DEFAULTS: c_int = 0;
pub const FUSE_READDIR_PLUS: c_int = 1;
pub const enum_fuse_readdir_flags = c_uint;
pub const FUSE_FILL_DIR_DEFAULTS: c_int = 0;
...
pub const struct_fuse_config = extern struct {
    set_gid: i32 = @import("std").mem.zeroes(i32),
    gid: u32 = @import("std").mem.zeroes(u32),
    set_uid: i32 = @import("std").mem.zeroes(i32),
    uid: u32 = @import("std").mem.zeroes(u32),
    set_mode: i32 = @import("std").mem.zeroes(i32),
    umask: u32 = @import("std").mem.zeroes(u32),
    ...
    intr: i32 = @import("std").mem.zeroes(i32),
    intr_signal: i32 = @import("std").mem.zeroes(i32),
    remember: i32 = @import("std").mem.zeroes(i32),
    hard_remove: i32 = @import("std").mem.zeroes(i32),
    use_ino: i32 = @import("std").mem.zeroes(i32),
    readdir_ino: i32 = @import("std").mem.zeroes(i32),
    direct_io: i32 = @import("std").mem.zeroes(i32),
    kernel_cache: i32 = @import("std").mem.zeroes(i32),
    auto_cache: i32 = @import("std").mem.zeroes(i32),
    ac_attr_timeout_set: i32 = @import("std").mem.zeroes(i32),
    ac_attr_timeout: f64 = @import("std").mem.zeroes(f64),
    nullpath_ok: i32 = @import("std").mem.zeroes(i32),
    show_help: i32 = @import("std").mem.zeroes(i32),
    modules: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    debug: i32 = @import("std").mem.zeroes(i32),
    fmask: u32 = @import("std").mem.zeroes(u32),
    dmask: u32 = @import("std").mem.zeroes(u32),
    no_rofd_flush: i32 = @import("std").mem.zeroes(i32),
    parallel_direct_writes: i32 = @import("std").mem.zeroes(i32),
    flags: u32 = @import("std").mem.zeroes(u32),
    reserved: [48]u64 = @import("std").mem.zeroes([48]u64),
};
pub const struct_fuse_operations = extern struct {
    ...
    init: ?*const fn (?*struct_fuse_conn_info, [*c]struct_fuse_config) callconv(.c) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*struct_fuse_conn_info, [*c]struct_fuse_config) callconv(.c) ?*anyopaque),
    ...
    ioctl: ?*const fn ([*c]const u8, c_int, ?*anyopaque, ?*struct_fuse_file_info, c_uint, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, c_int, ?*anyopaque, ?*struct_fuse_file_info, c_uint, ?*anyopaque) callconv(.c) c_int),
    ...
    statx: ?*const fn ([*c]const u8, c_int, c_int, ?*struct_statx, ?*struct_fuse_file_info) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, c_int, c_int, ?*struct_statx, ?*struct_fuse_file_info) callconv(.c) c_int),
};
...
pub extern fn fuse_main_real_versioned(argc: c_int, argv: [*c][*c]u8, op: [*c]const struct_fuse_operations, op_size: usize, version: [*c]struct_libfuse_version, user_data: ?*anyopaque) c_int;
pub fn fuse_main_real(arg_argc: c_int, arg_argv: [*c][*c]u8, arg_op: [*c]const struct_fuse_operations, arg_op_size: usize, arg_user_data: ?*anyopaque) callconv(.c) c_int {
    ...
    var op = arg_op;
    _ = &op;
    var op_size = arg_op_size;
    _ = &op_size;
    var user_data = arg_user_data;
    _ = &user_data;
    var version: struct_libfuse_version = struct_libfuse_version{
        .major = @as(u32, @bitCast(@as(c_int, 3))),
        .minor = @as(u32, @bitCast(@as(c_int, 18))),
        .hotfix = @as(u32, @bitCast(@as(c_int, 1))),
        .padding = @as(u32, @bitCast(@as(c_int, 0))),
    };
    _ = &version;
    fuse_log(@as(c_uint, @bitCast(FUSE_LOG_ERR)), "%s is a libfuse internal function, please use fuse_main()\n", "fuse_main_real");
    return fuse_main_real_versioned(argc, argv, op, op_size, &version, user_data);
}
pub fn fuse_main_fn(arg_argc: c_int, arg_argv: [*c][*c]u8, arg_op: [*c]const struct_fuse_operations, arg_user_data: ?*anyopaque) callconv(.c) c_int {
    var argc = arg_argc;
    _ = &argc;
    var argv = arg_argv;
    _ = &argv;
    ...
    _ = &version;
    return fuse_main_real_versioned(argc, argv, op, @sizeOf(struct_fuse_operations), &version, user_data);
}
pub extern fn fuse_lib_help(args: [*c]struct_fuse_args) void;
pub extern fn _fuse_new_30(args: [*c]struct_fuse_args, op: [*c]const struct_fuse_operations, op_size: usize, version: [*c]struct_libfuse_version, user_data: ?*anyopaque) ?*struct_fuse;
pub extern fn _fuse_new_31(args: [*c]struct_fuse_args, op: [*c]const struct_fuse_operations, op_size: usize, version: [*c]struct_libfuse_version, user_data: ?*anyopaque) ?*struct_fuse;
pub fn fuse_new_fn(arg_args: [*c]struct_fuse_args, arg_op: [*c]const struct_fuse_operations, arg_op_size: usize, arg_user_data: ?*anyopaque) callconv(.c) ?*struct_fuse {
    var args = arg_args;
    _ = &args;
    var op = arg_op;
    _ = &op;
...
pub extern fn fuse_loop_mt_31(f: ?*struct_fuse, clone_fd: c_int) c_int;
...
pub extern fn fuse_fs_statx(fs: ?*struct_fuse_fs, path: [*c]const u8, flags: c_int, mask: c_int, stxbuf: ?*struct_statx, fi: ?*struct_fuse_file_info) c_int;
pub extern fn fuse_fs_init(fs: ?*struct_fuse_fs, conn: ?*struct_fuse_conn_info, cfg: [*c]struct_fuse_config) void;
...
pub const FUSE_HOTFIX_VERSION = @as(c_int, 1);
pub const FUSE_MAJOR_VERSION = @as(c_int, 3);
pub const FUSE_MINOR_VERSION = @as(c_int, 18);
pub const FUSE_RC_VERSION = "";
...
pub const FUSE_CAP_ASYNC_READ = @as(c_ulong, 1) << @as(c_int, 0);
pub const FUSE_CAP_POSIX_LOCKS = @as(c_ulong, 1) << @as(c_int, 1);
pub const FUSE_CAP_ATOMIC_O_TRUNC = @as(c_ulong, 1) << @as(c_int, 3);
pub const FUSE_CAP_EXPORT_SUPPORT = @as(c_ulong, 1) << @as(c_int, 4);
pub const FUSE_CAP_DONT_MASK = @as(c_ulong, 1) << @as(c_int, 6);
pub const FUSE_CAP_SPLICE_WRITE = @as(c_ulong, 1) << @as(c_int, 7);
pub const FUSE_CAP_SPLICE_MOVE = @as(c_ulong, 1) << @as(c_int, 8);
pub const FUSE_CAP_SPLICE_READ = @as(c_ulong, 1) << @as(c_int, 9);
pub const FUSE_CAP_FLOCK_LOCKS = @as(c_ulong, 1) << @as(c_int, 10);
pub const FUSE_CAP_IOCTL_DIR = @as(c_ulong, 1) << @as(c_int, 11);
pub const FUSE_CAP_AUTO_INVAL_DATA = @as(c_ulong, 1) << @as(c_int, 12);
pub const FUSE_CAP_READDIRPLUS = @as(c_ulong, 1) << @as(c_int, 13);
pub const FUSE_CAP_READDIRPLUS_AUTO = @as(c_ulong, 1) << @as(c_int, 14);
pub const FUSE_CAP_ASYNC_DIO = @as(c_ulong, 1) << @as(c_int, 15);
pub const FUSE_CAP_WRITEBACK_CACHE = @as(c_ulong, 1) << @as(c_int, 16);
pub const FUSE_CAP_NO_OPEN_SUPPORT = @as(c_ulong, 1) << @as(c_int, 17);
pub const FUSE_CAP_PARALLEL_DIROPS = @as(c_ulong, 1) << @as(c_int, 18);
pub const FUSE_CAP_POSIX_ACL = @as(c_ulong, 1) << @as(c_int, 19);
pub const FUSE_CAP_HANDLE_KILLPRIV = @as(c_ulong, 1) << @as(c_int, 20);
pub const FUSE_CAP_HANDLE_KILLPRIV_V2 = @as(c_ulong, 1) << @as(c_int, 21);
pub const FUSE_CAP_CACHE_SYMLINKS = @as(c_ulong, 1) << @as(c_int, 23);
pub const FUSE_CAP_NO_OPENDIR_SUPPORT = @as(c_ulong, 1) << @as(c_int, 24);
pub const FUSE_CAP_EXPLICIT_INVAL_DATA = @as(c_ulong, 1) << @as(c_int, 25);
pub const FUSE_CAP_EXPIRE_ONLY = @as(c_ulong, 1) << @as(c_int, 26);
pub const FUSE_CAP_SETXATTR_EXT = @as(c_ulong, 1) << @as(c_int, 27);
pub const FUSE_CAP_DIRECT_IO_ALLOW_MMAP = @as(c_ulong, 1) << @as(c_int, 28);
pub const FUSE_CAP_PASSTHROUGH = @as(c_ulong, 1) << @as(c_int, 29);
pub const FUSE_CAP_NO_EXPORT_SUPPORT = @as(c_ulong, 1) << @as(c_int, 30);
pub const FUSE_CAP_OVER_IO_URING = @as(c_ulong, 1) << @as(c_int, 31);
...
pub const FUSE_BACKING_STACKED_UNDER = @as(c_int, 0);
pub const FUSE_BACKING_STACKED_OVER = @as(c_int, 1);
pub const FUSE_BUFVEC_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// /usr/include/fuse3/fuse_common.h:969:9
...
pub inline fn fuse_main(argc: anytype, argv: anytype, op: anytype, user_data: anytype) @TypeOf(fuse_main_fn(argc, argv, op, user_data)) {
    ...
    _ = &op;
    _ = &user_data;
    return fuse_main_fn(argc, argv, op, user_data);
}
pub inline fn fuse_new(args: anytype, op: anytype, size: anytype, data: anytype) @TypeOf(fuse_new_fn(args, op, size, data)) {
    _ = &args;
    _ = &op;
    _ = &size;
    _ = &data;
    return fuse_new_fn(args, op, size, data);
}
pub inline fn fuse_loop_mt(f: anytype, clone_fd: anytype) @TypeOf(fuse_loop_mt_31(f, clone_fd)) {
    _ = &f;
    _ = &clone_fd;
    return fuse_loop_mt_31(f, clone_fd);
}
pub const FUSE_REGISTER_MODULE = @compileError("unable to translate macro: undefined identifier `fuse_module_`");
// /usr/include/fuse3/fuse.h:1414:9
...
pub const libfuse_version = struct_libfuse_version;
